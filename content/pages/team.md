...
- Journey entry point: to be refined during issue #7
...
|---|---|---|---|
| `CL-007` | See claims register | Use fallback until cleared | See claims register |
| `CL-010` | See claims register | Use fallback until cleared | See claims register |
| `CL-015` | See claims register | Use fallback until cleared | See claims register |

## Draft copy

Not frozen. Draft copy must be produced under issue #7 using `docs/content/copy-review-checklist.md`.
