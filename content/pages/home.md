...
page: "Home"
route: "/"
primary_audience: "Investors, deal owners, intermediaries"
primary_issue: "#6"
...
- Primary audience: Investors, deal owners, intermediaries
- Journey entry point: to be refined during issue #6
...
|---|---|---|---|
| `CL-001` | See claims register | Use fallback until cleared | See claims register |
...
| `CL-009` | See claims register | Use fallback until cleared | See claims register |
| `CL-010` | See claims register | Use fallback until cleared | See claims register |

## Draft copy

Not frozen. Draft copy must be produced under issue #6 using `docs/content/copy-review-checklist.md`.
